module Utils.Json
    exposing
        ...
        , decodeListAsEveryDictListByProperty
        )
...
decodeListAsEveryDictListByProperty : String -> Decoder key -> Decoder val -> Decoder (EveryDictList key val)
decodeListAsEveryDictListByProperty property keyDecoder valDecoder =
    map2 (,) (field property keyDecoder) valDecoder
        |> list
